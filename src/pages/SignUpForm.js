  ...
  return (
    <div style={styles.container}>
      <div style={styles.formContainer}>
        ...
        <div style={styles.socialButtons}>
          <button style={styles.googleButton}>
            Sign up with Google <span style={styles.googleLogo}>G</span>
          </button>
          <span style={styles.orText}>OR</span>
          <button style={styles.githubButton}>
            Sign up with Github <span style={styles.githubLogo}>🐱</span>
          </button>
        </div>
      ...
      <div style={styles.loginContainer}>
        <p style={styles.loginText}>Already registered ?<br />Start using now!</p>
        <button 
